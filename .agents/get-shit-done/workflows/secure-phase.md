...
```
Task(
  prompt="Read /home/delorenj/code/bhappy/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/delorenj/code/bhappy/.opencode/get-shit-done/templates/SECURITY.md`
