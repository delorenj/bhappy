...
```
Task(
  prompt="Read /home/delorenj/code/bhappy/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/delorenj/code/bhappy/.claude/get-shit-done/templates/SECURITY.md`
