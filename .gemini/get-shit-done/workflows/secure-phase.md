...
```
Task(
  prompt="Read /home/delorenj/code/bhappy/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/delorenj/code/bhappy/.gemini/get-shit-done/templates/SECURITY.md`
