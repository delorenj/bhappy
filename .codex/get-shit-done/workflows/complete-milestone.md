...
```bash
node "/home/delorenj/code/bhappy/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/home/delorenj/code/bhappy/.codex/get-shit-done/templates/retrospective.md`.
