...
```bash
INIT=$(node "/home/delorenj/code/bhappy/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/delorenj/code/bhappy/.codex/get-shit-done/templates/spec.md.
