...
- Usage: Reference from command with `@/home/delorenj/code/bhappy/.augment/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/delorenj/code/bhappy/.augment/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/delorenj/code/bhappy/.augment/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
