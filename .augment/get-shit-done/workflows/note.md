...
- **Global scope**: `/home/delorenj/code/bhappy/.augment/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/delorenj/code/bhappy/.augment/notes/`)
...
2. Glob `/home/delorenj/code/bhappy/.augment/notes/*.md` (if directory exists) — global notes
...
Global (/home/delorenj/code/bhappy/.augment/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/delorenj/code/bhappy/.augment/notes/` — works in any directory
