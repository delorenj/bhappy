...
```bash
INIT=$(node "/home/delorenj/code/bhappy/.augment/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/delorenj/code/bhappy/.augment/get-shit-done/bin/gsd-tools.cjs" commit \
